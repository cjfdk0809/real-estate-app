...
- 03 추정낙찰가: 거래사례비교법으로 낙찰예상가 산정. 계산식 = 기준시세 × 가치형성요인 × 낙찰가율. 'AI안'(요인 1.00·낙찰가율 캐스케이드)과 '담당자안'(요인·낙찰가율 직접보정) 중 하나를 최종 채택.
- 04 경매사례: 유사 경매 낙찰사례로 예상 낙찰가율의 근거 확보.
- 05 매물현황: 네이버 부동산 현재 호가(참고).
...
- 모르면 모른다고 하고, 앱에서 확인할 위치(예: '03 추정낙찰가 탭')를 안내.
